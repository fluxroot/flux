...
[![Build Status](https://travis-ci.org/fluxroot/flux.png?branch=2.2.x)](https://travis-ci.org/fluxroot/flux) [![Coverage Status](https://coveralls.io/repos/fluxroot/flux/badge.png?branch=2.2.x)](https://coveralls.io/r/fluxroot/flux?branch=2.2.x)
