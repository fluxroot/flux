...
public class KillerTableTest {
  ...
  public void testKillerMoves() {
    ...
    int move1 = Move.createMove(Move.NORMAL, 0, 16, IntChessman.NOPIECE, IntChessman.NOPIECE, IntChessman.NOPIECE);
    ...
    int move2 = Move.createMove(Move.NORMAL, 0, 16, IntChessman.NOPIECE, IntChessman.NOPIECE, IntChessman.NOPIECE);
    killerMoves.add(move2, 0);
    assertEquals(move2, killerMoves.getPrimaryKiller(0));
    assertEquals(Move.NOMOVE, killerMoves.getSecondaryKiller(0));

    // Put a new killer move into the list
    int move3 = Move.createMove(Move.NORMAL, 1, 17, IntChessman.NOPIECE, IntChessman.NOPIECE, IntChessman.NOPIECE);
    ...
    int move4 = Move.createMove(Move.NORMAL, 2, 18, IntChessman.NOPIECE, IntChessman.NOPIECE, IntChessman.NOPIECE);
