...
public class KillerTableTest {
  ...
  public void testKillerMoves() {
    ...
    int move1 = Move.createMove(Move.NORMAL, 0, 16, IntPiece.NOPIECE, IntPiece.NOPIECE, IntChessman.NOCHESSMAN);
    ...
    int move2 = Move.createMove(Move.NORMAL, 0, 16, IntPiece.NOPIECE, IntPiece.NOPIECE, IntChessman.NOCHESSMAN);
    killerMoves.add(move2, 0);
    assertEquals(move2, killerMoves.getPrimaryKiller(0));
    assertEquals(Move.NOMOVE, killerMoves.getSecondaryKiller(0));

    // Put a new killer move into the list
    int move3 = Move.createMove(Move.NORMAL, 1, 17, IntPiece.NOPIECE, IntPiece.NOPIECE, IntChessman.NOCHESSMAN);
    ...
    int move4 = Move.createMove(Move.NORMAL, 2, 18, IntPiece.NOPIECE, IntPiece.NOPIECE, IntChessman.NOCHESSMAN);
