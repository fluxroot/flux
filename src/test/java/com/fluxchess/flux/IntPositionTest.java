...
public class IntPositionTest {
  ...
  public void testIntPosition() {
    Assert.assertEquals(0, IntPosition.valueOfPosition(GenericPosition.valueOf(GenericFile.Fa, GenericRank.R1)));
    ...
    for (int position : rank1) {
      ...
      assertEquals(IntPosition.rank1, IntPosition.getRelativeRank(position, Color.WHITE));
      assertEquals(IntPosition.rank8, IntPosition.getRelativeRank(position, Color.BLACK));
    }
    ...
    for (int position : rank2) {
      ...
      assertEquals(IntPosition.rank2, IntPosition.getRelativeRank(position, Color.WHITE));
      assertEquals(IntPosition.rank7, IntPosition.getRelativeRank(position, Color.BLACK));
    }
    ...
    for (int position : rank3) {
      ...
      assertEquals(IntPosition.rank3, IntPosition.getRelativeRank(position, Color.WHITE));
      assertEquals(IntPosition.rank6, IntPosition.getRelativeRank(position, Color.BLACK));
    }
    ...
    for (int position : rank4) {
      ...
      assertEquals(IntPosition.rank4, IntPosition.getRelativeRank(position, Color.WHITE));
      assertEquals(IntPosition.rank5, IntPosition.getRelativeRank(position, Color.BLACK));
    }
    ...
    for (int position : rank5) {
      ...
      assertEquals(IntPosition.rank5, IntPosition.getRelativeRank(position, Color.WHITE));
      assertEquals(IntPosition.rank4, IntPosition.getRelativeRank(position, Color.BLACK));
    }
    ...
    for (int position : rank6) {
      ...
      assertEquals(IntPosition.rank6, IntPosition.getRelativeRank(position, Color.WHITE));
      assertEquals(IntPosition.rank3, IntPosition.getRelativeRank(position, Color.BLACK));
    }
    ...
    for (int position : rank7) {
      ...
      assertEquals(IntPosition.rank7, IntPosition.getRelativeRank(position, Color.WHITE));
      assertEquals(IntPosition.rank2, IntPosition.getRelativeRank(position, Color.BLACK));
    }
    ...
    for (int position : rank8) {
      ...
      assertEquals(IntPosition.rank8, IntPosition.getRelativeRank(position, Color.WHITE));
      assertEquals(IntPosition.rank1, IntPosition.getRelativeRank(position, Color.BLACK));
    }
